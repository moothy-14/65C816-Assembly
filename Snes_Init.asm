...
Reset:
	...
	sei 	 		; Disabled interrupts
 	...
 	rep	#%00011000 	; "nvmxdizc" Binary mode (decimal mode off), X/Y 16 bit
	sep	#%00100100  ; A 8 bit, IRQ Disable
    ...
    txs
 	...
 	stz	WH1			; Window 1 right position register
 	stz	WH2 		; Window 2 left position register
 	stz	WH3  		; Window 2 right position register
 	...
 	stz	WRDIVL   	; Dividend Low
 	stz	WRDIVH   	; Dividend High
